...
ID3D11Texture2D* JViewRT::CreateTexture(UINT Width, UINT Height)
{
	HRESULT hr = S_OK;
...
HRESULT JViewRT::SetRenderTargetView(ID3D11Texture2D* pBackBuffer)
{
	HRESULT hr = S_OK;
...
HRESULT JViewRT::CreateRenderTargetView(UINT Width, UINT Height)
{
	HRESULT hr = S_OK;
...
bool JViewRT::Create(UINT Width, UINT Height)
{
...
bool JViewRT::Begin(ID3D11DeviceContext* pContext)
{
	m_nViewPorts = 1;
...
bool JViewRT::End(ID3D11DeviceContext* pContext)
{
	ID3D11RenderTargetView* pRTV = nullptr;
	ID3D11DepthStencilView* pDSV = nullptr;
	pContext->OMSetRenderTargets(1, &pRTV, pDSV);
...
void JViewRT::Save(ID3D11DeviceContext* pContext,
